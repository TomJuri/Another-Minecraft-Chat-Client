...
public class ClientPlayerPositionAndLookPacket extends Packet {
     ...
     */
    public ClientPlayerPositionAndLookPacket(final PacketRegistry reg, final Double x, final Double y, final Double z, final Float yaw, final Float pitch, final Boolean onGround) {
        super(reg);
        putDouble(x);
        putDouble(y);
        putDouble(z);
