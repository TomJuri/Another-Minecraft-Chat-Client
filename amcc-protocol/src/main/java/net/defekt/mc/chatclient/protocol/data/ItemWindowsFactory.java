...
public class ItemWindowsFactory {
     ...
     * @return items window
     */
    public ItemsWindow createWindow(final String title, final int size, final int windowID, final MinecraftClient client, final PacketRegistry registry) {
        try {
            final ItemsWindow window = (ItemsWindow) itemWindowsClass.getConstructors()[0].newInstance(title,
                                                                                                       size,
                                                                                                       windowID,
                                                                                                       client,
                                                                                                       registry);
